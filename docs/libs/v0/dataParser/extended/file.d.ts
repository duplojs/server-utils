 ...
 * 
 */
export declare function file<const GenericDefinition extends Omit<Partial<dataParsers.DataParserDefinitionFile>, "mimeType" | "minSize" | "maxSize"> = never>(params?: dataParsers.DataParserFileParams, definition?: GenericDefinition): DataParserFileExtended<DP.MergeDefinition<dataParsers.DataParserDefinitionFile, NeverCoalescing<GenericDefinition, {}>>>;
