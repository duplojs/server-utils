...
export interface Option<GenericName extends string = string, GenericExecuteOutputValue extends unknown = unknown> extends Kind<typeof optionKind.definition> {
    ...
    execute(args: readonly string[], error: CommandError): Promise<{
...
export declare function initOption<GenericName extends string, GenericExecuteOutputValue extends unknown>(name: GenericName, execute: (params: InitOptionExecuteParams, error: CommandError) => MaybePromise<GenericExecuteOutputValue | SymbolCommandError>, params?: {
    description?: string;
