...
declare module "@duplojs/utils/dataParser" {
    ...
    interface EligibleChecker<GenericValue extends unknown> {
        file: IsExtends<GenericValue, DServerFile.FileInterface> extends true ? (AllServerDataParser.DataParserCheckerFileExist | AllServerDataParser.DataParserCheckerFileSize | AllServerDataParser.DataParserCheckerFileMimeType) : never;
    }
}
