...
declare module "../implementor" {
    interface ServerUtilsFunction {
        appendFile(path: string, data: Uint8Array): Promise<FileSystemLeft<"append-file"> | EE.Ok>;
    }
}
/**
 ...
 * 
 */
export declare const appendFile: (path: string, data: Uint8Array) => Promise<FileSystemLeft<"append-file"> | EE.Ok>;
